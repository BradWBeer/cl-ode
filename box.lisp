...
(defmethod initialize-instance :after ((this physics-box) &key total-mass density)
  ...
  (when (and (not (body this))
    ...
    (let ((m (make-instance 'physics-mass)))
      ...
      (cond (density    (mass-set-box (pointer m) density (x this) (y this) (z this)))
	    (total-mass (mass-set-box-total (pointer m) total-mass (x this) (y this) (z this)))
	    (t (mass-set-box (pointer m) 1 (x this) (y this) (z this))))
